...
def img_process(img):
    ...
    img = cv2.putText(img, str(steer), (200, height), cv2.FONT_HERSHEY_SIMPLEX, 2, 125, 3) # write text
...
class HocarminiController(Node):
    def __init__(self):
        ...
        self.image_subscriber_ = self.create_subscription(Image, "image", self.image_callback, QoSProfile(depth=10))
